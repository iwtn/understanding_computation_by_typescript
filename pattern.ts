...
part('Complex')
const pattern6 = new Repeat(new Concatenate(new Literal('a'), new Choose(new Empty(), new Literal('b'))))
assert('(a(|b))*', pattern6.toS())
assert(true, pattern6.isMatch(''))
assert(true, pattern6.isMatch('a'))
assert(true, pattern6.isMatch('ab'))
assert(true, pattern6.isMatch('aba'))
assert(true, pattern6.isMatch('abab'))
assert(true, pattern6.isMatch('abaab'))
assert(false, pattern6.isMatch('abba'))
